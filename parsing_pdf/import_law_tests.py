#!/usr/bin/env python3
"""
Скрипт для импорта тестов по предмету Ҳуқуқ в базу данных Django
...
def import_law_tests(json_file_path):
...
def main():
    json_file = os.path.join(os.path.dirname(__file__), 'law_tests_import.json')
    ...
    print("="*60)
    print("ИМПОРТ ТЕСТОВ ПО ПРЕДМЕТУ ҲУҚУҚ (ПРАВО)")
    print("="*60)
    print()
